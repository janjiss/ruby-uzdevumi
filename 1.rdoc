= Ruby uzdevums programmētājiem:

== Uzdevuma mērķis

* Ieejas dati * : Izveidot klasi, kurai inicializēšanas brīdī tiek padots blāķis ar tekstu.

* Izejas dati * : Klasei jāatgriež sekojošās vērtības ar sekojošiem atribūtiem:
...
* Klases nodefinēšana izskatās šādi: *
...
Inicializēšanas brīdī someClass.new ir iespējams padot argumentus metodei initialize. Piemēram:
...
* Arguments, kurš ir pieejams visā klasē: *
